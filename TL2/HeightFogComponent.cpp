...
UHeightFogComponent::UHeightFogComponent()
    : FogDensity(0.001f)       // Default fog density (adjust based on scene scale)
    , FogHeightFalloff(0.01f)  // Default height falloff
    ...
    , FogInscatteringColor(FLinearColor::White) // White fog
{
