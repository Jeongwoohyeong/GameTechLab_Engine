...
void AEnemyCharacter::MoveF// 충돌 콜백 등록 (CollisionComponent 사용)
	...
	CollisionComponent->OnComponentHit.AddDynamic(this, &AEnemyCharacter::OnHit);// 충돌 콜백 등록 (CollisionComponent 사용)
	CollisionComponent->OnComponentBeginOverlap.AddDynamic(this, &AEnemyCharacter::OnBeginOverlap);
	CollisionComponent->OnComponentEndOverlap.AddDynamic(this, &AEnemyCharacter::OnEndOverlap);
	CollisionComponent->OnComponentHit.AddDynamic(this, &AEnemyCharacter::OnHit);orward(float Value)
{
	if (Value == 0.0f)
	{
		return;
