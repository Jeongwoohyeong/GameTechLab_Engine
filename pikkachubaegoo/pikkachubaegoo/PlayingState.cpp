...
void PlayingState::Enter()
{
	...
	player1 = UObjectFactory::GetInstance()->CreatePlayer(PLAYER1_INDEX, FVector3(-PLAYER_BASE_POSITION_X)); // Player 1
	player2 = UObjectFactory::GetInstance()->CreatePlayer(PLAYER2_INDEX, FVector3(PLAYER_BASE_POSITION_X)); // Player 2
